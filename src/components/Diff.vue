<template>
  ...
  .diff-box {
    ...
    background-color: #2a2a2a;
    max-width: 100%; /* Ensure diff-box does not exceed the width */
  ...
  .diff-box pre {
    ...
    overflow-wrap: break-word; /* Handles breaking long words for wrapping */
    font-family: monospace;
    max-width: 100%; /* Ensure pre does not exceed the width of diff-box */
